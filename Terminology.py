...
class GraphNode:
    ...
    def connect_curve(self, counter_clock_adj_self, other, clockwise_adj_other, angle=TAU / 4):
        line_self = Line(
            counter_clock_adj_self.circle.get_center(), self.circle.get_center())
        unit_vector_self = line_self.get_unit_vector()
        line_other = Line(
            clockwise_adj_other.circle.get_center(), other.circle.get_center())
...
class GraphAnimationUtils(Scene):
    ...
    def Definitions(self):
        intuition_title = Tex("DAG")
        intuition_title.scale(1.2)
        intuition_title.move_to(UP * 3.5)
        h_line = Line(LEFT, RIGHT).scale(4) #FRAME_X_RADIUS - 1
        h_line.next_to(intuition_title, DOWN)
        ...
        self.wait(12)  # here we explain what a DAG is
        indicate = graph[3].circle
        self.play(
            Create(indicate.set_fill(PINK, opacity=0.5)),
            # Create(graph[1].circle),
            run_time=2
        )
        self.wait(5)

        #past:
        past_title = Tex("PAST(B,G)")
        past_title.scale(1.2)
        past_title.move_to(UP * 3.5)
        self.play(
            Transform(intuition_title, past_title),
            run_time=3
        )
        ...
        self.play(
            Transform(graph[1].circle, graph[1].circle.set_fill(GREEN)),
            Transform(graph[0].circle, graph[0].circle.set_fill(GREEN)),
            Transform(graph[2].circle, graph[2].circle.set_fill(GREEN)),
            run_time=3
        )
        ...
        self.play(
            Transform(graph[1].circle, graph[1].circle.set_fill(BLUE)),
            Transform(graph[0].circle, graph[0].circle.set_fill(BLUE)),
            Transform(graph[2].circle, graph[2].circle.set_fill(BLUE)),
        )
        
        #future:
        f_title = Tex("FUTURE(B,G)")
        f_title.scale(1.2)
        f_title.move_to(UP * 3.5)
        self.play(
            Transform(intuition_title, f_title),
            run_time=3
        )
        ...
        self.play(
            Transform(graph[5].circle, graph[5].circle.set_fill(GREEN)),
            Transform(graph[8].circle, graph[8].circle.set_fill(GREEN)),
            Transform(graph[7].circle, graph[7].circle.set_fill(GREEN)),
            Transform(graph[9].circle, graph[9].circle.set_fill(GREEN)),
            Transform(graph[10].circle, graph[10].circle.set_fill(GREEN)),
            run_time=3
        )
        ...
        self.play(
            Transform(graph[5].circle, graph[5].circle.set_fill(BLUE)),
            Transform(graph[8].circle, graph[8].circle.set_fill(BLUE)),
            Transform(graph[7].circle, graph[7].circle.set_fill(BLUE)),
            Transform(graph[9].circle, graph[9].circle.set_fill(BLUE)),
            Transform(graph[10].circle, graph[10].circle.set_fill(BLUE)),
            run_time=3
        )
        
        #Anticone:
        ac_title = Tex("Anticone(B,G)")
        ac_title.scale(1.2)
        ac_title.move_to(UP * 3.5)
        self.play(
            Transform(intuition_title, ac_title),
            run_time=3
        )

        self.wait(5)
        test = graph[6].circle.copy()
        test.set_fill(GREEN)
        self.add(test)
        self.play(
            Transform(graph[6].circle, graph[6].circle.set_fill(GREEN_B)),
            Transform(graph[4].circle, graph[4].circle.set_fill(GREEN_B)),
            run_time=3
        )
        ...
        self.play(
            Transform(graph[6].circle, graph[6].circle.set_fill(BLUE)),
            Transform(graph[4].circle, graph[4].circle.set_fill(BLUE)),
            run_time=3
        )
        ...
        t_title = Tex("Tips(G)")
        t_title.scale(1.2)
        t_title.move_to(UP * 3.5)
        self.play(
            Transform(intuition_title, t_title),
            run_time=3
        )
...
class k_cluster(Scene):
    def construct(self):
        intuition_title = Tex("K-Cluster")
        intuition_title.scale(1.2)
        intuition_title.move_to(UP * 3.5)
        h_line = Line(LEFT, RIGHT).scale(4) #FRAME_X_RADIUS - 1
        h_line.next_to(intuition_title, DOWN)
        ...
        #1-cluster
        a1_title = Tex("k=3: 3-cluster")
        a1_title.scale(1.2)
        a1_title.move_to(UP * 3.5)
        self.play(
            Transform(intuition_title, a1_title),
            run_time=3
        )
        for i in range(len(graph)):
            indicate = graph[i].circle
            self.play(
                Create(indicate.set_fill(PINK, opacity=0.5)),
                run_time=2
            )
            ...
            if(i == 1):
                self.play(
                    Transform(graph[2].circle, graph[2].circle.set_fill(GREEN)),
                    Transform(graph[6].circle, graph[6].circle.set_fill(GREEN)),
                    run_time=2
                )
                self.wait(5)
                title = Tex("k=2")
                title.next_to(graph[1].circle, direction=LEFT*2)
                self.play(
                    Create(title),
                    run_time=3
                )
            ...
            if(i == 2):
                title = Tex("k=2")
                title.next_to(graph[2].circle, direction=LEFT*2)
                self.play(
                    Create(title),
                    run_time=3
                )
            if(i == 3):
                self.play(
                    Transform(graph[4].circle, graph[4].circle.set_fill(GREEN)),
                    Transform(graph[6].circle, graph[6].circle.set_fill(GREEN)),
                    run_time=2
                )
                self.wait(5)
                title = Tex("k=2")
                title.next_to(graph[3].circle, direction=LEFT)
                self.play(
                    Create(title),
                    run_time=3
                )
            ...
            if(i == 4):
                title = Tex("k=3")
                title.next_to(graph[4].circle, direction=LEFT)
                self.play(
                    Create(title),
                    run_time=3
                )
            if(i == 5):
                title = Tex("k=1")
                title.next_to(graph[5].circle, direction=DOWN)
                self.play(
                    Create(title),
                    run_time=3
                )
            if(i == 6):
                title = Tex("k=8")
                # title.color(RED)
                title.next_to(graph[6].circle, direction=RIGHT)
                self.play(
                    Create(title),
                    run_time=3
                )
            if(i==7):
                ...
                self.wait(5)
                title = Tex("k=3")
                title.next_to(graph[7].circle, direction=RIGHT)
                self.play(
                    Create(title),
                    run_time=3
                )
            ...
            if(i == 8):
                title = Tex("k=3")
                title.next_to(graph[8].circle, direction=DOWN)
                self.play(
                    Create(title),
                    run_time=3
                )
            if(i == 9):
                title = Tex("k=3")
                title.next_to(graph[9].circle, direction=DOWN)
                self.play(
                    Create(title),
                    run_time=3
                )
            ...
            if(i == 10):
                title = Tex("k=3")
                title.next_to(graph[6].circle, direction=DOWN)
                self.play(
                    Create(title),
                    run_time=3
                )
    ...
    def show_dfs_preorder(self, graph, edge_dict, full_order,
        ...
        for element in full_order:
            if isinstance(element, int):
                ...
                angle = self.find_angle_of_intersection(
                    graph, last_edge.get_end(), element[1])
    ...
    def create_dfs_graph(self):
        ...
        node_1 = GraphNode('1', position=LEFT * 3 + UP *
                           2, radius=radius, scale=scale)
        node_2 = GraphNode('2', position=LEFT * 3 + DOWN *
                           2, radius=radius, scale=scale)
        node_3 = GraphNode('3', position=LEFT * 1, radius=radius, scale=scale)
        node_4 = GraphNode('4', position=LEFT * 1 + UP *
                           2, radius=radius, scale=scale)
        node_5 = GraphNode('5', position=RIGHT * 1, radius=radius, scale=scale)
        node_6 = GraphNode('6', position=LEFT * 1 + DOWN *
                           2, radius=radius, scale=scale)
        node_7 = GraphNode('7', position=RIGHT * 3 + DOWN *
                           2, radius=radius, scale=scale)
        node_8 = GraphNode('8', position=RIGHT * 3 + UP *
                           2, radius=radius, scale=scale)
        node_9 = GraphNode('9', position=RIGHT * 5 + UP *
                           2, radius=radius, scale=scale)
    ...
    def create_dfs_graph_directed(self):
        ...
        node_4 = GraphNode('4', position=LEFT * 1 + UP *
                           2, radius=radius, scale=scale)
        node_5 = GraphNode('5', position=RIGHT * 1, radius=radius, scale=scale)
        node_6 = GraphNode('6', position=DOWN *
                           2, radius=radius, scale=scale)
        node_7 = GraphNode('7', position=RIGHT * 3 + DOWN *
                           2, radius=radius, scale=scale)
        node_8 = GraphNode('8', position=RIGHT * 3 + UP *
        ...
        node_9 = GraphNode('9', position=RIGHT * 5 + UP *
                           2, radius=radius, scale=scale)
        node_10 = GraphNode('10', position=RIGHT * 5 
                            , radius=radius, scale=scale)

        edges[(0, 2)] = node_2.connect_arrow(node_0)
        edges[(0, 1)] = node_1.connect_arrow(node_0)

        edges[(1, 4)] = node_4.connect_arrow(node_1)
        edges[(1, 3)] = node_3.connect_arrow(node_1)
        edges[(2, 3)] = node_3.connect_arrow(node_2)

        edges[(3, 5)] = node_5.connect_arrow(node_3)
        edges[(4, 5)] = node_5.connect_arrow(node_4)

        edges[(5, 8)] = node_8.connect_arrow(node_5)
        edges[(5, 7)] = node_7.connect_arrow(node_5)
        edges[(2, 6)] = node_6.connect_arrow(node_2)

        edges[(8, 9)] = node_9.connect_arrow(node_8)
        edges[(7, 10)] = node_10.connect_arrow(node_7)
        edges[(5, 10)] = node_10.connect_arrow(node_5)
    ...
    def create_small_graph(self):
        ...
        radius, scale = 0.4, 0.9
        node_0 = GraphNode('0', position=DOWN * 1 + LEFT *
                           3, radius=radius, scale=scale)
        node_1 = GraphNode('1', position=UP * 1 + LEFT,
                           radius=radius, scale=scale)
        node_2 = GraphNode('2', position=DOWN * 3 + LEFT,
                           radius=radius, scale=scale)
        node_3 = GraphNode('3', position=DOWN * 1 + RIGHT,
                           radius=radius, scale=scale)
        node_4 = GraphNode('4', position=DOWN * 1 + RIGHT *
                           3, radius=radius, scale=scale)
    ...
    def show_path(self, graph, edge_dict, path, scale_factor=1):
        ...
        for i in range(len(path) - 1):
            u, v = path[i], path[i + 1]
            surround_circle = self.highlight_node(
                graph, u, start_angle=angle/360 * TAU, scale_factor=scale_factor)
            last_edge = self.sharpie_edge(
                edge_dict, u, v, scale_factor=scale_factor)
            objects.extend([surround_circle, last_edge])
            angle = self.find_angle_of_intersection(
                graph, last_edge.get_end(), v)

        if v != path[0]:
            surround_circle = self.highlight_node(
                graph, v, start_angle=angle/360 * TAU, scale_factor=scale_factor)
    ...
    def show_path_in_graph(self, graph, edge_dict, scale_factor=1):
        ...
        last_edge = self.sharpie_edge(
            edge_dict, 0, 6, scale_factor=scale_factor)
        angle = self.find_angle_of_intersection(graph, last_edge.get_end(), 6)
        self.highlight_node(graph, 6, start_angle=angle /
                            360 * TAU, scale_factor=scale_factor)

        last_edge = self.sharpie_edge(
            edge_dict, 6, 7, scale_factor=scale_factor)
        angle = self.find_angle_of_intersection(graph, last_edge.get_end(), 7)
        self.highlight_node(graph, 7, start_angle=angle /
                            360 * TAU, scale_factor=scale_factor)

        last_edge = self.sharpie_edge(
            edge_dict, 7, 3, scale_factor=scale_factor)
        angle = self.find_angle_of_intersection(graph, last_edge.get_end(), 3)
        self.highlight_node(graph, 3, start_angle=angle /
                            360 * TAU, scale_factor=scale_factor)

        last_edge = self.sharpie_edge(
            edge_dict, 3, 2, scale_factor=scale_factor)
        angle = self.find_angle_of_intersection(graph, last_edge.get_end(), 2)
        self.highlight_node(graph, 2, start_angle=angle /
                            360 * TAU, scale_factor=scale_factor)
    ...
    def find_angle_of_intersection(self, graph, last_point, node_index):
        ...
        for angle in range(360):
            ...
            respective_line.rotate(
                rotate_angle, about_point=node.circle.get_center())
    ...
    def highlight_node(self, graph, index, color=GREEN,
        ...
        node = graph[index]
        surround_circle = Circle(
            radius=node.circle.radius * scale_factor, TAU=-TAU, start_angle=start_angle)
    ...
    def create_initial_graph(self):
        ...
        radius, scale = 0.4, 0.9
        SHIFT = RIGHT * 2.5
        node_0 = GraphNode('0', position=LEFT * 2.5,
                           radius=radius, scale=scale)
        node_1 = GraphNode('1', position=RIGHT * 3, radius=radius, scale=scale)
        node_2 = GraphNode('2', position=RIGHT * 1.5 +
                           UP, radius=radius, scale=scale)
        node_3 = GraphNode('3', position=UP * 2.5 + SHIFT,
                           radius=radius, scale=scale)
        node_4 = GraphNode('4', position=DOWN * 2, radius=radius, scale=scale)
        node_5 = GraphNode('5', position=DOWN + RIGHT *
                           2, radius=radius, scale=scale)
        node_6 = GraphNode('6', position=LEFT + UP, radius=radius, scale=scale)
        node_7 = GraphNode('7', position=LEFT * 2 + UP *
                           2 + SHIFT, radius=radius, scale=scale)
    ...
    def create_disconnected_graph(self):
        ...
        left_shift = LEFT * 0.5
        node_0 = GraphNode('0', position=LEFT * 2.5 +
                           left_shift, radius=radius, scale=scale)
        node_1 = GraphNode('1', position=RIGHT * 3 +
                           right_shift, radius=radius, scale=scale)
        node_2 = GraphNode('2', position=RIGHT * 1.5 + UP +
                           right_shift, radius=radius, scale=scale)
        node_3 = GraphNode('3', position=UP * 2.5 + SHIFT +
                           right_shift, radius=radius, scale=scale)
        node_4 = GraphNode('4', position=DOWN * 2 +
                           left_shift, radius=radius, scale=scale)
        node_5 = GraphNode('5', position=DOWN + RIGHT * 2 +
                           right_shift, radius=radius, scale=scale)
        node_6 = GraphNode('6', position=LEFT + UP +
                           left_shift, radius=radius, scale=scale)
        node_7 = GraphNode('7', position=LEFT * 2 + UP * 2 +
                           SHIFT + left_shift, radius=radius, scale=scale)
        node_8 = GraphNode('8', position=ORIGIN + left_shift,
                           radius=radius, scale=scale)
    ...
    def make_graph_mobject(self, graph, edge_dict, node_color=BLUE,
...
class ThumbnailYoutube(GraphAnimationUtils):
    def construct(self):
        ...
        nodes, edges = self.make_graph_mobject(
            graph, edge_dict, show_data=False)
        entire_graph = VGroup(nodes, edges)
        ...
        objects = self.show_path(graph, edge_dict, [
                                 4, 10, 16, 22, 29, 36, 42, 48, 55, 62, 68, 74, 81], scale_factor=1)
...
class GraphTraversal(GraphAnimationUtils):
    ...
    def show_graph_traversal_term(self, h_line, title):
        ...
        node_mobjects, edge_mobjects = self.make_graph_mobject(
            graph, edge_dict, scale_factor=scale_factor)
        entire_graph = VGroup(node_mobjects, edge_mobjects)

        traversal_term = TextMobject(
            r"Graph Traversal - algorithm to visit every vertex of a graph")
        traversal_term[:14].set_color(GREEN)
        ...
        surround_circle = self.highlight_node(
            graph, 0, animate=False, scale_factor=scale_factor)
        self.play(
            ShowCreation(surround_circle)
        )
        self.wait(2)

        other_nodes = [self.highlight_node(
            graph, i, animate=False, scale_factor=scale_factor) for i in range(1, len(graph))]
        self.play(
        ...
        dfs_focus = TextMobject(
            "In this video, we will focus on the DFS graph traversal")
        dfs_focus.scale(0.8)
...
class DFSImplementation(GraphAnimationUtils):
    ...
    def recursive_implementation(self):
        ...
        all_highlights = self.show_second_dfs_preorder(
            graph, edge_dict, dfs_full_order, order[9:], wait_times)
        self.wait()
        ...
        to_fade = [surround_circle, nodes[0], edge_dict[(
            0, 1)], edge_dict[(0, 2)], edge_dict[(0, 3)]]
        self.play(
            *[FadeOut(obj) for obj in to_fade]
        )

        all_highlights = self.show_dfs_preorder(
            graph, edge_dict, dfs_full_order[2:], wait_times)

        order[-4:].set_color(GREEN)
        self.wait(2)
        ...
        wait_times[0] = 2
        all_highlights = self.show_dfs_preorder(
            graph, edge_dict, dfs_full_order[:3], wait_times)
        self.wait(15)
    ...
    def visualize_recursion(self, code):
        ...
        surround_circle = self.highlight_node(
            graph_0, 0, scale_factor=scale_factor)
        self.play(
            TransformFromCopy(graph_0[0].data, order_0[0])
        )
        self.wait(10)
        line_0 = self.sharpie_edge(
            edge_dict_0, 0, 1, scale_factor=scale_factor, animate=False)
        self.play(
            ShowCreation(line_0)
        )
        ...
        surround_circle_0 = self.highlight_node(
            graph_1, 0, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        line_1 = self.sharpie_edge(
            edge_dict_1, 0, 1, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        ...
        node_1 = self.highlight_node(
            graph_1, 1, scale_factor=scale_factor, animate=False)
        node_0 = self.highlight_node(
            graph_0, 1, scale_factor=scale_factor, animate=False)
        ...
        line_1 = self.sharpie_edge(
            edge_dict_1, 1, 3, scale_factor=scale_factor, animate=False)
        line_0 = self.sharpie_edge(
            edge_dict_0, 1, 3, scale_factor=scale_factor, animate=False)
        self.play(
            ShowCreation(line_1),
            ShowCreation(line_0)
        )
        ...
        surround_circle_0 = self.highlight_node(
            graph_3, 0, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        edge_01 = self.sharpie_edge(
            edge_dict_3, 0, 1, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        surround_circle_1 = self.highlight_node(
            graph_3, 1, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        edge_13 = self.sharpie_edge(
            edge_dict_3, 1, 3, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        all_highlights.extend(
            [surround_circle_0, edge_01, surround_circle_1, edge_13])
        ...
        node_3 = self.highlight_node(
            graph_3, 3, scale_factor=scale_factor, animate=False)
        node_1 = self.highlight_node(
            graph_1, 3, scale_factor=scale_factor, animate=False)
        node_0 = self.highlight_node(
            graph_0, 3, scale_factor=scale_factor, animate=False)
        ...
        line_3 = self.sharpie_edge(
            edge_dict_3, 3, 4, scale_factor=scale_factor, animate=False)
        line_1 = self.sharpie_edge(
            edge_dict_1, 3, 4, scale_factor=scale_factor, animate=False)
        line_0 = self.sharpie_edge(
            edge_dict_0, 3, 4, scale_factor=scale_factor, animate=False)
        self.play(
            ShowCreation(line_3),
            ShowCreation(line_1),
            ShowCreation(line_0)
        ...
        surround_circle_0 = self.highlight_node(
            graph_4, 0, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        edge_01 = self.sharpie_edge(
            edge_dict_4, 0, 1, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        surround_circle_1 = self.highlight_node(
            graph_4, 1, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        edge_13 = self.sharpie_edge(
            edge_dict_4, 1, 3, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        surround_circle_3 = self.highlight_node(
            graph_4, 3, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        edge_34 = self.sharpie_edge(
            edge_dict_4, 3, 4, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        all_highlights.extend(
            [surround_circle_0, edge_01, surround_circle_1, edge_13, surround_circle_3, edge_34])
        ...
        node_4 = self.highlight_node(
            graph_4, 4, scale_factor=scale_factor, animate=False)
        node_3 = self.highlight_node(
            graph_3, 4, scale_factor=scale_factor, animate=False)
        node_1 = self.highlight_node(
            graph_1, 4, scale_factor=scale_factor, animate=False)
        node_0 = self.highlight_node(
            graph_0, 4, scale_factor=scale_factor, animate=False)
        ...
        line_3 = self.sharpie_edge(
            edge_dict_3, 3, 2, scale_factor=scale_factor, animate=False)
        line_1 = self.sharpie_edge(
            edge_dict_1, 3, 2, scale_factor=scale_factor, animate=False)
        line_0 = self.sharpie_edge(
            edge_dict_0, 3, 2, scale_factor=scale_factor, animate=False)
        self.play(
            ShowCreation(line_3),
            ShowCreation(line_1),
            ShowCreation(line_0)
        ...
        surround_circle_0 = self.highlight_node(
            graph_2, 0, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        edge_01 = self.sharpie_edge(
            edge_dict_2, 0, 1, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        surround_circle_1 = self.highlight_node(
            graph_2, 1, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        edge_13 = self.sharpie_edge(
            edge_dict_2, 1, 3, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        surround_circle_3 = self.highlight_node(
            graph_2, 3, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        edge_34 = self.sharpie_edge(
            edge_dict_2, 3, 4, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        surround_circle_4 = self.highlight_node(
            graph_2, 4, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        edge_32 = self.sharpie_edge(
            edge_dict_2, 3, 2, scale_factor=scale_factor, animate=False, color=BRIGHT_RED)
        all_highlights.extend([surround_circle_0, edge_01, surround_circle_1,
                              edge_13, surround_circle_3, edge_34, surround_circle_4, edge_32])
        ...
        node_2 = self.highlight_node(
            graph_2, 2, scale_factor=scale_factor, animate=False)
        node_3 = self.highlight_node(
            graph_3, 2, scale_factor=scale_factor, animate=False)
        node_1 = self.highlight_node(
            graph_1, 2, scale_factor=scale_factor, animate=False)
        node_0 = self.highlight_node(
            graph_0, 2, scale_factor=scale_factor, animate=False)
...
class DFSIteratitiveImplementation(GraphAnimationUtils):
    ...
    def iterative_implementation(self):
        ...
        dfs_full_order = dfs(graph, 0)
        wait_times = [0] * len(dfs_full_order)
        new_highlights = self.show_second_dfs_preorder(
            graph, edge_dict, dfs_full_order[:1], order[1], wait_times, scale_factor=scale_factor)
        all_highlights.extend(new_highlights)
        ...
        new_highlights = self.show_second_dfs_preorder(
            graph, edge_dict, dfs_full_order[1:3], order[1][1:], wait_times, scale_factor=scale_factor)
        all_highlights.extend(new_highlights)
        ...
        new_highlights = self.show_second_dfs_preorder(
            graph, edge_dict, dfs_full_order[3:5], order[1][2:], wait_times, scale_factor=scale_factor)
        all_highlights.extend(new_highlights)
        ...
        new_highlights = self.show_second_dfs_preorder(
            graph, edge_dict, dfs_full_order[5:7], order[1][3:], wait_times, scale_factor=scale_factor)
        all_highlights.extend(new_highlights)
        ...
        new_highlights = self.show_second_dfs_preorder(
            graph, edge_dict, dfs_full_order[7:9], order[1][4:], wait_times, scale_factor=scale_factor)
        all_highlights.extend(new_highlights)
...
class ImplementationComparison(Scene):
    def construct(self):
        ...
        rect_left = SurroundingRectangle(
            code_rec, buff=SMALL_BUFF, color=WHITE)

        rect_right = SurroundingRectangle(
            code_iter, buff=SMALL_BUFF, color=WHITE)
...
class PostOrder(GraphAnimationUtils):
    ...
    def show_postorder(self):
        ...
        new_highlights = self.show_second_dfs_preorder(
            graph, edge_dict, dfs_second_full_order[:5], preorder[9:], wait_times)
        self.wait(10)
        ...
        new_highlights = self.show_second_dfs_preorder(
            graph, edge_dict, dfs_second_full_order[5:11], preorder[12:], wait_times)
        self.wait()
        graph[6].surround_circle.set_color(BRIGHT_RED)
        self.play(
        ...
        new_highlights = self.show_second_dfs_preorder(
            graph, edge_dict, dfs_second_full_order[11:-2], preorder[15:-1], wait_times)
        self.wait()
        graph[9].surround_circle.set_color(BRIGHT_RED)
        self.play(
        ...
        new_highlights = self.show_second_dfs_preorder(
            graph, edge_dict, dfs_second_full_order[-2:], preorder[-1:], wait_times)
        all_highlights.extend(new_highlights)
        self.wait()
        graph[4].surround_circle.set_color(BRIGHT_RED)
        self.play(
...
class DFSApplications(GraphAnimationUtils):
    ...
    def show_cycle_detection(self, h_line):
        ...
        objects = self.show_path(
            graph, edge_dict, [0, 3, 2, 0], scale_factor=scale_factor)
    ...
    def show_connected_component(self, h_line):
        ...
        surround_rectangle_1 = SurroundingRectangle(
            component_1, color=GREEN, buff=SMALL_BUFF)
        self.play(
        ...
        surround_rectangle_2 = SurroundingRectangle(
            component_2, color=GREEN, buff=SMALL_BUFF)
        self.play(
            ShowCreation(surround_rectangle_2)
        )
        self.wait(5)

        all_highlight_fadeouts = [FadeOut(h)
                                  for h in highlights_1 + highlights_2]
    ...
    def show_topological_sort(self, h_line):
        ...
        surround_circles = [self.highlight_node(
            graph, i, scale_factor=scale_factor, animate=False) for i in range(len(graph))]
        ...
        for node_id in dfs_pre_order:
            ...
            if node_id == dfs_post_order[post_order_i]:
                ...
                self.play(
                    TransformFromCopy(
                        graph[node_id].data, dfs_postorder[1][post_order_i])
                )
                post_order_i += 1
            if node_id == 9:
                break
        ...
        for post_order_i in range(3, 7):
            ...
            surround_circles[node_id].set_color(BRIGHT_RED)
            self.play(
                TransformFromCopy(graph[node_id].data,
                                  dfs_postorder[1][post_order_i])
            )
        ...
        reverse_dfs_postorder = TextMobject(
            "Reverse DFS Postorder:", "0 1 4 3 5 7 8 9 6 2")
    ...
    def show_path(self, graph, edge_dict, path, scale_factor=1, directed=False):
        ...
        for i in range(len(path) - 1):
            ...
            surround_circle = self.highlight_node(
                graph, u, start_angle=angle/360 * TAU, scale_factor=scale_factor)
            last_edge = self.sharpie_edge(
                edge_dict, u, v, scale_factor=scale_factor, directed=directed)
            objects.extend([surround_circle, last_edge])
            angle = self.find_angle_of_intersection(
                graph, last_edge.get_end(), v)
    ...
    def sharpie_edge(self, edge_dict, u, v, color=GREEN, scale_factor=1, animate=True, directed=False, run_time=1):
        switch = False
        if u > v:
            edge = edge_dict[(v, u)]
            switch = True
...
class MazeGeneration(GraphAnimationUtils):
    ...
    def show_maze_generation(self):
        ...
        nodes, edges = self.make_graph_mobject(
            graph, edge_dict, scale_factor=0.5, show_data=False)
        entire_graph = VGroup(nodes, edges)
        self.play(
            FadeOut(grid_group)
        )
    ...
    def show_dfs_maze_preorder(self, graph, edge_dict, full_order,
                               wait_times, rows, cols, scale_factor=1, run_time=1, color=GREEN):
        i = 0
        angle = 180
        all_highlights = []
        for element in full_order:
    ...
    def sharpie_edge_maze(self, graph, u, v, rows, cols, color=GREEN,
                          scale_factor=1, animate=True, run_time=1):
        switch = False
        if u > v:
            switch = True
        ...
        if not switch:
            start = graph[u].circle.get_center() - orientation * \
                graph[u].circle.radius
            end = graph[v].circle.get_center() + orientation * \
                graph[v].circle.radius
            line = Line(start, end)
        else:
            start = graph[v].circle.get_center() + orientation * \
                graph[u].circle.radius
            end = graph[u].circle.get_center() - orientation * \
                graph[u].circle.radius
            line = Line(start, end)
        line.set_stroke(width=16 * scale_factor)
        line.set_color(color)
    ...
    def make_graph_from_grid(self, grid):
        ...
        for i in range(len(grid)):
            for j in range(len(grid[0])):
                node = GraphNode(
                    node_id, position=grid[i][j].get_center(), radius=radius, scale=scale)
                graph.append(node)
                node_id += 1
        ...
        for i in range(len(grid) - 1):
            for j in range(len(grid[0])):
                edge_dict[(i * len(grid[0]) + j, (i + 1) * len(grid[0]) + j)] = graph[i *
                                                                                      len(grid[0]) + j].connect(graph[(i + 1) * len(grid[0]) + j])
...
class TestDFSFunctions(GraphAnimationUtils):
    def construct(self):
        graph, edge_dict = self.create_dfs_graph()
        nodes, edges = self.make_graph_mobject(
            graph, edge_dict, scale_factor=1)
        entire_graph = VGroup(nodes, edges)
        self.play(
            FadeIn(entire_graph)
        )
...
class Logo(Scene):
    def construct(self):
        hexagon = RegularPolygonDepreciated(
            n=6, color=VIOLET, fill_color=VIOLET, fill_opacity=1, sheen_factor=0.2)
        hexagon.scale(2)
        ...
        triangle = RegularPolygonDepreciated(
            color=LIGHT_VIOLET, fill_color=LIGHT_VIOLET, fill_opacity=1, sheen_factor=0.2)
